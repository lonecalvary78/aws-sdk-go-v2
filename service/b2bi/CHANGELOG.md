# v1.0.0-preview.113 (2026-07-06)

* **Feature**: Add request serialization snapshot tests.

# v1.0.0-preview.112 (2026-07-01)

* **Bug Fix**: Bump smithy-go to 1.27.3, fix JSON encorder for document.Number, endpoint host label format validation and CBOR union serialization on new serde
* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.111 (2026-06-29)

* No change notes available for this release.

# v1.0.0-preview.110 (2026-06-08)

* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.109 (2026-06-05.2)

* **Bug Fix**: Undo the initial wave of schema-serde releases due to several customer-reported regressions.

# v1.0.0-preview.108 (2026-06-04)

* **Dependency Update**: Update to smithy-go v1.27.1 to fix several union-related deserialization bugs in schema-serde-enabled services.
* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.107 (2026-06-03)

* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.106 (2026-06-02)

* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.105 (2026-05-29)

* **Dependency Update**: Update to smithy-go v1.26.0.
* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.104 (2026-05-28)

* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.103 (2026-05-22)

* **Feature**: Adding new BDD representation of endpoint ruleset

# v1.0.0-preview.102 (2026-04-29)

* **Dependency Update**: Update to smithy-go v1.25.1.
* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.101 (2026-04-17)

* **Dependency Update**: Bump smithy-go to 1.25.0 to support endpointBdd trait
* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.100 (2026-03-26)

* **Bug Fix**: Fix a bug where a recorded clock skew could persist on the client even if the client and server clock ended up realigning.
* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.99 (2026-03-13)

* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.98 (2026-03-03)

* **Dependency Update**: Bump minimum Go version to 1.24
* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.97 (2026-02-23)

* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.96 (2026-01-09)

* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.95 (2025-12-08)

* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.94 (2025-12-02)

* **Dependency Update**: Updated to the latest SDK module versions
* **Dependency Update**: Upgrade to smithy-go v1.24.0. Notably this version of the library reduces the allocation footprint of the middleware system. We observe a ~10% reduction in allocations per SDK call with this change.

# v1.0.0-preview.93 (2025-11-25)

* **Bug Fix**: Add error check for endpoint param binding during auth scheme resolution to fix panic reported in #3234

# v1.0.0-preview.92 (2025-11-19.2)

* **Dependency Update**: Updated to the latest SDK module versions

# v1.0.0-preview.91 (2025-11-12)

* **Bug Fix**: Further reduce allocation overhead when the metrics system isn't in-use.
* **Bug Fix**: Reduce allocation overhead when the client doesn't have any HTTP interceptors configured.
* **Bug Fix**: Remove blank trace spans towards the beginning of the request that added no additional information. This conveys a slight reduction in overall allocations.

# v1.0.0-preview.90 (2025-11-11)

* **Bug Fix**: Return validation error if input region is not a valid host label.

# v1.0.0-preview.89 (2025-11-04)

* **Dependency Update**: Updated to the latest SDK module versions
* **Dependency Update**: Upgrade to smithy-go v1.23.2 which should convey some passive reduction of overall allocations, especially when not using the metrics system.

# v1.0.0-preview.88 (2025-10-30)
